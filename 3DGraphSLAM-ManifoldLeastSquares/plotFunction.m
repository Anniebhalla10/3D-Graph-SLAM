...
function plot_all_landmarks(landmarksg)
    ...
    scatter3(landmarksg(1,:), landmarksg(2,:), landmarksg(3,:), 'red', 'filled'); % ground truth in red
    ...
    for i = 1:length(all_landmarks)
        ...
        % Plot landmarks
        h1 = scatter3(landmarks(1,:), landmarks(2,:), landmarks(3,:), 'blue','o' );
